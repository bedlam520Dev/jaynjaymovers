...
import { Menu, X, LayoutDashboard, LogOut, Shield, Home } from 'lucide-react';
    ...
    <div className='absolute top-3 right-3 z-55'>
      <button
        ...
        className={cn(
          ...
          'z-56 rounded-[1.25rem] border-4 border-primary border-inset bg-background/60 p-1.5 text-xl font-bold text-primary transition-all duration-200 ease-out',
          'hover:scale-105 hover:border-primary/60 active:scale-95',
          menuOpen && 'scale-95 border-primary bg-background/60 shadow-md'
        )}
      >
        {menuOpen ? (
          <X className='h-[clamp(1rem,1.75vh,1.75rem)] w-[clamp(1rem,1.75vh,1.75rem)] stroke-5' />
        ) : (
          <Menu className='h-[clamp(1rem,1.75vh,1.75rem)] w-[clamp(1rem,1.75vh,1.75rem)] stroke-5' />
        )}
      </button>
              ...
              <>
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === '/home' &&
                      'border-primary/80 bg-background/60 text-secondary shadow-xs'
                  )}
                >
                  <Home className='h-4 w-4 stroke-2' /> Home
                </Link>
                ...
                {profile?.is_admin && (
                  ...
                  >
                    <Shield className='h-4 w-4 stroke-2' /> Admin CRM
                  </Link>
                )}
