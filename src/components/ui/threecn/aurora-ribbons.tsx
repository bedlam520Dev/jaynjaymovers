...
} from '@/components/ui/threecn/scene-container';
import { useShadcnTheme, type ThemeMode } from '@/hooks/use-shadcn-theme';
...
function Ribbons({
  ...
  const { primaryColor, accentColor, mutedColor, isDark } = useShadcnTheme(theme);
