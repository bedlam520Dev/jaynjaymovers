...
const SheetNavigationContext = createContext<SheetNavigationContextType | undefined>(
  undefined
);

const EMPTY_STACK: StackItem[] = [];

export function SheetNavigationProvider({
  children,
  onStackEmpty,
  initialStack = EMPTY_STACK,
}: {
  children: ReactNode;
  onStackEmpty?: () => void;
  ...
  return (
    <SheetNavigationContext.Provider value={value}>
      {children}
