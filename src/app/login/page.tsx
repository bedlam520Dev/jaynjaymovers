...
export default function LoginPage() {
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      // OAuth redirects away; if it returns without redirecting, show a message.
  ...
  return (
    <div className="animate-fade-in grid min-h-screen w-full md:grid-cols-2">
      ...
      <div className="relative hidden flex-col justify-between overflow-hidden bg-teal-700 p-10 text-white md:flex">
        <img
          src="https://images.pexels.com/photos/8021875/pexels-photo-8021875.jpeg?auto=compress&cs=tinysrgb&w=1200"
        ...
        <div className="relative z-10 space-y-4">
          <h1 className="text-4xl font-bold leading-tight">{SITE.tagline}</h1>
          <p className="max-w-md text-teal-50/90">
            Sign in to manage your bookings, schedule moves, and track your quotes — all in one place.
          </p>
          <ul className="space-y-2 pt-2 text-sm text-teal-50/90">
            <li className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 text-amber-400" /> Licensed, bonded &amp; insured
            </li>
            <li className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 text-amber-400" /> Transparent, upfront pricing
            </li>
            <li className="flex items-center gap-2">
      ...
      <div className="flex items-center justify-center bg-slate-50 p-6 sm:p-10">
        <Card className="w-full max-w-md border-teal-100 shadow-lg">
          <CardHeader className="space-y-2 text-center">
            ...
            <CardDescription>Sign in to your {SITE.name} account</CardDescription>
          </CardHeader>
